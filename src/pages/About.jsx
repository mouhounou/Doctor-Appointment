    ...
    return (
        <div className='text-center text-2xl pt-10 text-gray-500 '>
            ...
            <div className='my-10 flex flex-col md:flex-row gap-12 '>
                ...
                <div className='flex flex-col justify-center text-start gap-6 md:w-2/4 text-sm text-gray-600'>
                    <p>
                    ...
                    <p>
                        ...
                        We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the 
